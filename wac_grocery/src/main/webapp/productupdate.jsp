        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="plist" aria-expanded="false">
							<i class="flaticon-025-dashboard"></i>
							<span class="nav-text">Products</span>
						</a>
                    </li>
                    <li><a href="slist" aria-expanded="false">
...
<form method="post" action="pupd" enctype="multipart/form-data" style="max-width: 600px; margin: 30px auto; padding: 20px; border: 1px solid #ccc; border-radius: 10px; background-color: #f8f9fa; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
<div style="margin-bottom: 15px;">
        <label for="id" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Id:</label>
        <input type="text" id="name" name="id" value="<%= id %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #fff; readonly"/>
    </div>
    
    <div style="margin-bottom: 15px;">
        <label for="name" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Product Name:</label>
        <input type="text" id="name" name="name" value="<%= name %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #fff;"/>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="price" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Price:</label>
        <input type="text" id="price" name="price" value="<%= price %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #fff;"/>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="des" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Description:</label>
        <input type="text" id="des" name="des" value="<%= des %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #f1f1f1;"/>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="images" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Upload Image:</label>
        <input type="file" id="images" name="images" value="<%= img %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #fff;"/>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="stock" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Stock:</label>
        <input type="number" id="stock" name="stock" value="<%= stock %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #fff;"/>
    </div>

    <button type="submit" style="width: 100%; padding: 12px; background-color: #28a745; color: white; font-weight: bold; border: none; border-radius: 5px; font-size: 1.1em; cursor: pointer; transition: background-color 0.3s ease;">
        Submit
    </button>
</form>
        ...
        <div class="footer">
            ...
            <div class="copyright">
                <p>© Designed &amp; by <a href="#" target="_blank">iamsahan.dev</a> 2024</p>
            </div>
        </div>
	</div>
