...
<form method="post" action="supd" enctype="multipart/form-data" style="max-width: 600px; margin: 30px auto; padding: 20px; border: 1px solid #ccc; border-radius: 10px; background-color: #f8f9fa; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    
    <div style="margin-bottom: 15px;">
        <label for="name" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Product Name:</label>
        <input type="text" id="name" name="id" value="<%= id %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #fff;"/>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="price" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Name:</label>
        <input type="text" id="price" name="name" value="<%= name %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #fff;"/>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="des" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Email:</label>
        <input type="email" id="des" name="email" value="<%= email %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #f1f1f1;"/>
    </div>
    ...
    <div style="margin-bottom: 15px;">
        <label for="stock" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Phone:</label>
        <input type="text" id="stock" name="phone" value="<%= phone %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #fff;"/>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="stock" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #333;">Item:</label>
        <input type="text" id="stock" name="stock" value="<%= supItem %>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em; background-color: #fff;"/>
    </div>
