                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
								<a href="addsupplier.jsp" class="btn btn-primary d-sm-inline-block d-none">Add Supplier<i class="las la-signal ms-3 scale5"></i></a>
							</li>
                        </ul>
                    </div>
				</nav>
										...
										<thead>
											...
											<c:forEach var="cus" items="${supplier}">
												<tr>
													...
													<td>
														<h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">${cus.id}</a></h6>
													...
													<td><a href="supplierupdate.jsp?id=${cus.id }&name=${cus.name}&email=${cus.email}&phone=${cus.phone}&supItem=${cus.supItem}">Update</a></td>
													<td><a href="supdel?id=${cus.id }">Delete</a></td>
