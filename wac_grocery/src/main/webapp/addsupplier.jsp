...
<div id="preloader">
							...
							<div class="card-body tab-content p-0">
								<div class="tab-pane active show fade" id="monthly" role="tabpanel">
									<div class="table-responsive">
										<form method="post" action="addsup" enctype="multipart/form-data" style="max-width: 600px; margin: 30px auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9fafc; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);" onsubmit="return validateForm()">

    <h2 style="text-align: center; color: #333; margin-bottom: 20px; font-family: Arial, sans-serif;">Add Supplier</h2>

    <div style="margin-bottom: 15px;">
        <label for="name" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #444;">Supplier Name:</label>
        <input type="text" id="name" name="name" required minlength="3" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em;"/>
        <small id="nameError" style="color: red; display: none;">Supplier name must be at least 3 characters long.</small>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="email" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #444;">Email:</label>
    ...
    <div style="margin-bottom: 15px;">
        <label for="phone" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #444;">Phone:</label>
        <input type="text" id="phone" name="phone" required pattern="\d{10}" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em;"/>
        <small id="phoneError" style="color: red; display: none;">Phone number must be exactly 10 digits.</small>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="supItem" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #444;">Supplier Item:</label>
        <input type="text" id="supItem" name="supItem" required minlength="3" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em;"/>
        <small id="supItemError" style="color: red; display: none;">Supplier item must be at least 3 characters long.</small>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="images" style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 1.1em; color: #444;">Upload Image:</label>
        <input type="file" id="images" name="images" required accept="image/*" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 1em;"/>
        <small id="imageError" style="color: red; display: none;">Please upload a valid image file.</small>
    </div>
    ...
    <button type="submit" style="width: 100%; padding: 12px; background-color: #28a745; color: white; font-weight: bold; border: none; border-radius: 5px; font-size: 1.1em; cursor: pointer; transition: background-color 0.3s ease;">
        ...
        <div class="footer">
            ...
            <div class="copyright">
                <p>© Designed &amp; by <a href="#" target="_blank">wac design</a> 2024</p>
            </div>
        </div>
	</div>
