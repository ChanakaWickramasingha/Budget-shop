...
<div id="preloader">
							...
							<div class="card-body tab-content p-0">
								<div class="tab-pane active show fade" id="monthly" role="tabpanel">
									<div class="table-responsive">
										<form method="post" action="addprod" enctype="multipart/form-data" style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;" onsubmit="return validateForm()">
    <div style="margin-bottom: 15px;">
        ...
        <small id="nameError" style="color: red; display: none;">Product name must be at least 3 characters long.</small>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="price" style="display: block; font-weight: bold; margin-bottom: 5px;">Price:</label>
        <input type="number" id="price" name="price" required min="1" step="0.01" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;"/>
        <small id="priceError" style="color: red; display: none;">Please enter a valid price (greater than 0).</small>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="des" style="display: block; font-weight: bold; margin-bottom: 5px;">Description:</label>
        <input type="text" id="des" name="des" required minlength="10" maxlength="200" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; background-color: #f0f0f0;"/>
        <small id="desError" style="color: red; display: none;">Description must be between 10 and 200 characters.</small>
    </div>

    <div style="margin-bottom: 15px;">
        <label for="images" style="display: block; font-weight: bold; margin-bottom: 5px;">Upload Image:</label>
        <input type="file" id="images" name="images" required style="padding: 5px; border: 1px solid #ccc; border-radius: 5px;" accept="image/*"/>
    ...
    <div style="margin-bottom: 15px;">
        ...
        <input type="number" id="stock" name="stock" required min="1" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;"/>
        <small id="stockError" style="color: red; display: none;">Please enter a valid stock value (greater than 0).</small>
    </div>

    <button type="submit" style="width: 100%; padding: 10px; background-color: #28a745; color: white; font-weight: bold; border: none; border-radius: 5px; cursor: pointer;">
        Submit
    </button>
</form>
