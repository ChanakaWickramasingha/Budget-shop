                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
								<a href="addProduct.jsp" class="btn btn-primary d-sm-inline-block d-none">Add Product<i class="las la-signal ms-3 scale5"></i></a>
							</li>
                        </ul>
                    </div>
				</nav>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="logout.jsp" aria-expanded="false">
										...
										<table class="table table-responsive-md card-table transactions-table">
										    ...
										    <tbody>
										        <c:forEach var="cus" items="${products}">
										            <tr>
										                <td>
										                    <img src="${cus.img}" style="width:100px; height:100px"/>
										                </td>
										                <td>
										                    <h6 class="fs-16 font-w600 mb-0">${cus.id}</h6>
										                </td>
										                <td>
										                    <h6 class="fs-16 font-w600 mb-0">
										                        <a href="javascript:void(0);" class="text-black">${cus.stock}</a>
										                    </h6>
										                </td>
										                <td>
										                    <h6 class="fs-16 text-black font-w600 mb-0">${cus.name}</h6>
										                </td>
										                <td>
										                    <span class="fs-16 text-black font-w600">${cus.price}</span>
										                </td>
										                <td>
										                    <a href="productupdate.jsp?id=${cus.id}&name=${cus.name}&price=${cus.price}&img=${cus.img}&des=${cus.des}&stock=${cus.stock}">Update</a>
										                </td>
										                <td>
										                    <a href="proddel?id=${cus.id}">Delete</a>
										                </td>
										            </tr>
										        </c:forEach>  
										    </tbody>
