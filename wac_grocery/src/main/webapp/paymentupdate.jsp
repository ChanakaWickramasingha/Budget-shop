...
<form method="post" action="payupd" enctype="multipart/form-data" style="max-width: 500px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    <h2 style="text-align: center; color: #333;">Update Payment Method</h2>
    
    <label for="name" style="display: block; margin-bottom: 8px; color: #555;">Id:</label>
    <input type="text" id="name" name="id" value="<%= id %>" readonly required style="width: 100%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 5px;">
    
    <label for="name" style="display: block; margin-bottom: 8px; color: #555;">Type:</label>
    <input type="text" id="name" name="type" value="<%= type %>" required style="width: 100%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 5px;">

    <label for="price" style="display: block; margin-bottom: 8px; color: #555;">Cno:</label>
    <input type="text"  name="cno" value="<%= cno %>" required style="width: 100%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 5px;">

    <label for="des" style="display: block; margin-bottom: 8px; color: #555;">Expiration Date:</label>
    <input type="text" id="des" name="exp" value="<%= exp %>" required style="width: 100%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 5px;">

    <label for="stock" style="display: block; margin-bottom: 8px; color: #555;">CVV:</label>
    <input type="number" id="stock" name="cvv" value="<%= cvv %>" required style="width: 100%; padding: 10px; margin-bottom: 15px; border: 1px solid #ddd; border-radius: 5px;">

    <label for="images" style="display: block; margin-bottom: 8px; color: #555;">Upload Image:</label>
    <input type="file" id="images" name="images" value="<%= img %>" required style="margin-bottom: 15px;">
